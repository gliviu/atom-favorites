...
function addContextMenus(){
  ...
  atom.contextMenu.add({
    'atom-text-editor, .tree-view .directory, .tab.texteditor': [
      { type: 'separator' },
...
// Parses '    "value"   # comment   ' into 'value'
function parse_cson_value(cson_value){
  return cson_value.replace(/^\s*?["']/, '').replace(/["']\s*?(#.*)?$/, '')
}
